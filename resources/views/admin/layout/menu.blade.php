<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Tim kiem thong tin<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="#">Theo ly lich</a>
                    </li>
                    <li>
                        <a href="#">Theo so luong tong</a>
                    </li>
                    <li>
                        <a href="#">Theo so luong</a>
                    </li>
                    <li>
                        <a href="#">Theo so tong thoi gian</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
